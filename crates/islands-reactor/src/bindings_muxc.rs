...
windows_core::imp::define_interface!(
    IBackdropMaterialFactory,
    IBackdropMaterialFactory_Vtbl,
    0x1d1f674f_cb53_5c41_aa3e_15f30c8ef7a5
);
impl windows_core::RuntimeType for IBackdropMaterialFactory {
    const SIGNATURE: windows_core::imp::ConstBuffer =
        windows_core::imp::ConstBuffer::for_interface::<Self>();
}
#[repr(C)]
pub struct IBackdropMaterialFactory_Vtbl {
    pub base__: windows_core::IInspectable_Vtbl,
}
windows_core::imp::define_interface!(
